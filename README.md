...
# How to use:
- Connect to the AP named `Tuhin` with password `xyz1234` from your phone/PC.
...
- Once a correct password is found, AP will be restarted with default ssid `Tuhin` / `xyz1234` and at the bottom of a table you should be able to see something like "Successfully got password for - `TARGET_SSID` - `PASSWORD`
